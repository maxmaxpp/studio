        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-center md:text-left">
                <motion.h1
                    ...
                    className="text-lg md:text-xl font-bold font-headline tracking-tight text-foreground/90"
                >
                    Bringing Clarity, 
                    Creativity, and Care 
                    to Your Business
            ...
            >
                <div className="relative w-[300px] h-[400px] md:w-[350px] md:h-[460px] rounded-t-full overflow-hidden shadow-2xl shadow-primary/20 -mt-8">
                     <Image
